      ...
      <div className="footer-container">
        <div className="ft-info">
          <div className="ft-info-p1">
            ...
            <p className="ft-description">Swimmpl emade swimming simple</p>
          </div>
        ...
        <div className="ft-list">
          ...
          <ul className="ft-list-items">
            <li>
              <Link to={"/legal"}>Swimming</Link>
            </li>
            <li>
              <Link to={"/legal"}>Ethelete Training</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="ft-list">
          ...
          <ul className="ft-list-items">
            <li>
              <Link to={"/legal"}>Career</Link>
            </li>
            <li>
              <Link to={"/legal"}>Blogs</Link>
            </li>
            <li>
              <Link to={"/legal"}>Case Studies</Link>
            </li>
            <li>
